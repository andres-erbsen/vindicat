...
void protobuf_AddDesc_vindicat_2eproto_impl() {
...
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
GOOGLE_PROTOBUF_DECLARE_ONCE(protobuf_AddDesc_vindicat_2eproto_once_);
void protobuf_AddDesc_vindicat_2eproto() {
  ::google::protobuf::::google::protobuf::GoogleOnceInit(&protobuf_AddDesc_vindicat_2eproto_once_,
                 &protobuf_AddDesc_vindicat_2eproto_impl);
}
#else
...
const DeviceInfo& DeviceInfo::default_instance() {
  ...
  protobuf_AddDesc_vindicat_2eproto();
#else
  if (default_instance_ == NULL) protobuf_AddDesc_vindicat_2eproto();
#endif
